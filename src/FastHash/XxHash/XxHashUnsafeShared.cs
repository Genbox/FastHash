...
internal static class XxHashUnsafeShared
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static unsafe void XXH3_hashLong_internal_loop(ulong* acc, byte* input, int len, byte* secret, int secretSize, XXH3_f_accumulate_512_unsafe f_acc512, XXH3_f_scrambleAcc_unsafe f_scramble)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static unsafe void XXH3_accumulate(ulong* acc, byte* input, byte* secret, int nbStripes, XXH3_f_accumulate_512_unsafe f_acc512)
    {
