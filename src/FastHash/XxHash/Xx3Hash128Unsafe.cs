...
public static class Xx3Hash128Unsafe
{
    ...
    private static unsafe Uint128 XXH3_hashLong_128b_withSeed_internal(byte* input, int len, ulong seed64, byte* secret, int secretlen, XxHashShared.XXH3_f_accumulate_512 f_acc512, XxHashShared.XXH3_f_scrambleAcc f_scramble, XxHashShared.XXH3_f_initCustomSecret f_initSec)
    {
        if (seed64 == 0)
    ...
    private static unsafe Uint128 XXH3_hashLong_128b_internal(byte* input, int len, byte* secret, int secretSize, XxHashShared.XXH3_f_accumulate_512 f_acc512, XxHashShared.XXH3_f_scrambleAcc f_scramble)
    {
