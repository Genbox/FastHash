...
public class Rapid3HashTests
{
    ...
    public void TestVectors()
    {
        foreach (Vector vector in Vectors)
            Assert.Equal(vector.Expected, Rapid3Hash64.ComputeHash(vector.Data, vector.Seed));
    }
    ...
    public void ComputeIndexMatchesByteHash()
    {
        ...
        foreach (ulong input in inputs)
        {
            ...
            Assert.Equal(Rapid3Hash64.ComputeHash(data, 123), Rapid3Hash64.ComputeIndex(input, 123));
        }
    }
    ...
    public void MicroMatchesRapidForShortInputs()
    {
        ...
        {
            Assert.Equal(Rapid3Hash64.ComputeHash(data), Rapid3HashMicro64.ComputeHash(data));
            Assert.Equal(Rapid3Hash64.ComputeHash(data, 123), Rapid3HashMicro64.ComputeHash(data, 123));
        }
    }
    ...
    public void NanoMatchesRapidForShortInputs()
    {
        ...
        foreach (byte[] data in inputs)
        {
            Assert.Equal(Rapid3Hash64.ComputeHash(data), Rapid3HashNano64.ComputeHash(data));
            Assert.Equal(Rapid3Hash64.ComputeHash(data, 123), Rapid3HashNano64.ComputeHash(data, 123));
        }
    }
    ...
    {
        ulong micro0 = Rapid3HashMicro64.ComputeHash(Zeros1000);
        ulong micro1 = Rapid3HashMicro64.ComputeHash(Zeros1000, 123);
        ulong nano0 = Rapid3HashNano64.ComputeHash(Zeros1000);
        ulong nano1 = Rapid3HashNano64.ComputeHash(Zeros1000, 123);
